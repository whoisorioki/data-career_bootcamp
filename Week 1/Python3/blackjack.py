"""Blackjack, by the power vested in me!
...
def main():
    print('''Blackjack, by the power vested in me.
    ...
    while True: # Main game loop
        ...
        while True: # Keep looping untill player stands or busts.
            ...
            # Check is the player has a bust:
...
def displayHands(playerHand, dealerHand, showDealerHand):
    ...
    card id showDealerHand is False."""
    print()
    if showDealerHand:
...
def getHandValue(cards):
    ...
    worth 11 or 1 (this function picks the most ace value)."""
    value = 0
    numberOfAces = 0
    ...
    for card in cards:
        ...
        if rank == 'A':
            ...
            value += int(rank) # Numberd cards are worth their number.
...
def getMove(playerHand, money):
    ...
    while True: # Keep looping untill the player enters a correct move.
        ...
        # The player can double down on their first move, whic we can
